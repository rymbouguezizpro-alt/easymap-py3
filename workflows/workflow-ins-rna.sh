...
then  
	...
	#Execute hisat2 to align filtered reads to genome sequence
	{
		$location/hisat2/hisat2 -x $f1/$my_ix -U $f1/output_F1.fq -S $f1/alignment2.sam 2> $f2/bowtie2_gnm_std2.txt
...
{
	$location/hisat2/hisat2 -x $f1/$my_ix -U $f1/output_F2.fq -S $f1/alignment4.sam 2> $f2/bowtie2_local_gnm_std2.txt
